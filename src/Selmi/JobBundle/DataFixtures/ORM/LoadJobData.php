...
namespace Selmi\JobBundle\DataFixtures\ORM;
...
class LoadJobData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $em)
    {
        ...
        $job_sensio_labs->setLocation('Montreal, Canada');
        ...
        $job_sensio_labs->setExpiresAt(new \DateTime('2017-10-25'));
        ...
        $job_extreme_sensio->setLocation('Montreal, Canada');
        ...
        $job_extreme_sensio->setExpiresAt(new \DateTime('2017-10-25'));
